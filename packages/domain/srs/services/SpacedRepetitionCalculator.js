...
export class SpacedRepetitionCalculator {
    /**
    ...
    adjustForLateReview(currentState, currentDate) {
        ...
        const adjustedEaseFactorValue = Math.max(EaseFactor.MIN_EASE_FACTOR, currentState.easeFactor.value - penaltyFactor);
...
//# sourceMappingURL=SpacedRepetitionCalculator.js.map