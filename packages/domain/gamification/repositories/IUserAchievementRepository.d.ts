...
export interface IUserAchievementRepository {
     ...
     * 학생의 특정 업적 획득 여부 조회
     */
    findByStudentAndAchievement(studentId: StudentId, achievementId: UniqueEntityID): Promise<Result<UserAchievement>>;
    /**
     * 학생의 모든 업적 조회
     */
...
//# sourceMappingURL=IUserAchievementRepository.d.ts.map