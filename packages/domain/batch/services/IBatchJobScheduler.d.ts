...
export interface IBatchJobScheduler {
     ...
     * @returns 스케줄링 결과
     */
    scheduleRecurringJob(jobOptions: Omit<BatchJobScheduleOptions, 'scheduledAt'>, scheduleOptions: RecurringScheduleOptions): Promise<Result<void>>;
    /**
     * 즉시 실행할 배치 작업 스케줄링
     * @param options 스케줄링 옵션 (scheduledAt은 무시됨)
     * @returns 생성된 배치 작업
     */
    scheduleImmediateJob(options: Omit<BatchJobScheduleOptions, 'scheduledAt'>): Promise<Result<BatchJob>>;
    /**
     * 스케줄된 작업 취소
...
//# sourceMappingURL=IBatchJobScheduler.d.ts.map