...
import { StudentId, RewardCode } from '@woodie/domain';
export class RedeemRewardUseCase {
    rewardRedemptionService;
    constructor(rewardRedemptionService) {
    ...
    async execute(request) {
        ...
        try {
            // 보상 교환 실행
            const redemptionResult = await this.rewardRedemptionService.redeemReward(studentId, rewardCode);
...
//# sourceMappingURL=RedeemRewardUseCase.js.map