...
export class DeactivateAssignmentUseCase {
    ...
    async execute(request) {
        try {
            ...
            if (!assignment.isOwnedBy(request.teacherId.trim())) {
                return Result.fail('Only the assignment owner can deactivate assignments');
            }
            // 4. 비활성화
...
//# sourceMappingURL=DeactivateAssignmentUseCase.js.map