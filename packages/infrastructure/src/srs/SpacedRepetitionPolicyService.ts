 ...
 */
export class SpacedRepetitionPolicyService implements ISpacedRepetitionPolicy {
  private calculator: SpacedRepetitionCalculator
 ...
 */
export class MockSpacedRepetitionPolicyService implements ISpacedRepetitionPolicy {
  calculateNextInterval(
    currentState: ReviewState,
    feedback: ReviewFeedback
  ): ReviewCalculationResult {
